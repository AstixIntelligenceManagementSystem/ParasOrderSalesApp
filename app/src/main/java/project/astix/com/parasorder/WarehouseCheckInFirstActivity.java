...
public class WarehouseCheckInFirstActivity extends BaseActivity implements LocationListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,OnMapReadyCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
      ...
      //  fnGetDistributorList();
        ...
        arrDiatributorOtherDetails=helperDb.getDayStartSuplierOtherData();
...
/*
    ...
    public void saveDataToDatabase()
    {
       ...
       /* if (ll_gstDetails.getVisibility() == View.VISIBLE)
        ...
        //helperDb.open();
        helperDb.savetblSuplierMappingData(UniqueDistribtrMapId,""+userId,""+"0",flgGSTCapture,flgGSTCompliance,
